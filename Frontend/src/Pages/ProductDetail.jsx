...
const ProductDetail = () => {
  ...
  return (
    product && (
      <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-11">
        <div className="max-w-6xl w-full">
          <div>
            <p>
              <span>Home</span> /<span> Products</span> /
              <span> {product.category}</span> /
              <span className="text-[#FF6347]"> {product.name}</span>
            </p>{" "}
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-16 mt-4">
            <div className="flex gap-3">
              ...
              <div className="border border-gray-500/30 max-w-100 rounded overflow-hidden">
                <img
                  src={thumbnail ? thumbnail : product.image[0]}
            ...
            <div className="text-sm w-full md:w-1/2">
              ...
              <div className="flex items-center mt-10 gap-4 text-base">
                ...
                <button className="w-full py-3.5 cursor-pointer font-medium bg-[#FF6347] text-white hover:bg-[#E4553D] transition" onClick={()=>{ AddtoCart(product._id); navigate('/cart')}}>
                  Buy now
                </button>
              </div>
            </div>
        ...
        <div className="flex flex-col items-center mt-20">
          <div className="flex flex-col items-center w-max">
            ...
            <div className="w-20 h-0.5 bg-[#FF6347] rounded-full mt-2"></div>
          </div>
          ...
          <button className="mx-auto cursor-pointer px-12 my-16 py-2.5 border-rounded border border-[#FF9F88] text-primary hover:bg-[#FF9F88]/10 transition text-[#FF6347]">See More</button>
        </div>
      </div>
    )
  );
